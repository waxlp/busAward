package com.zz80z.busAward.core.shiro.filter;
...
import com.zz80z.busAward.core.shiro.cache.VCache;
...
public class KickoutSessionFilter extends AccessControlFilter {
	...
	protected boolean isAccessAllowed(ServletRequest request,
		...
		//如果不存在，创建一个新的
		infoMap = null == infoMap ? new LinkedHashMap<Integer, Serializable>() : infoMap;
