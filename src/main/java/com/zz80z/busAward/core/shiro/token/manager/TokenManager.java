package com.zz80z.busAward.core.shiro.token.manager;
...
import com.zz80z.busAward.common.utils.SpringContextUtil;
import com.zz80z.busAward.core.shiro.session.CustomSessionManager;
import com.zz80z.busAward.core.shiro.token.UserRealm;
import com.zz80z.busAward.core.shiro.token.ShiroToken;
...
public class TokenManager {
	...
	public static User login(User user,Boolean rememberMe){
		ShiroToken token = new ShiroToken(user.getUserName(), user.getUserPwd());
